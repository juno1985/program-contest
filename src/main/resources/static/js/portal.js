...
//	$('#nt-ui-chat-wrapper').draggable();
	...
	//初始化聊天窗口
	$('#chat-mainsection-messagebox-iscroll').append('<div class="chat_span"><img src="http://www.softcits.com/contest/img/default_kefu.png" class="kefu_chat_icon" /><p>您好,请问您想咨询那些方面</p></div>');
	//绑定发送按钮事件
...
//		sleep(1000);
	...
	function kefuAutoReply(str){
		...
		var new_reply = $('<div class="chat_span"><img src="http://www.softcits.com/contest/img/default_kefu.png" class="kefu_chat_icon" /><p>请留下您的电话或微信,稍后会有客服人员与您取得联系</p></div>').css('opacity',0);
